...
#define MPU9250_ADDRESS_ADO_HIGH		0x69
#define AK8963_ADDRESS  0x0C   // Address of magnetometer
#endif // AD0

#define MPU9250_ADDRESS_DEFAULT (MPU9250_ADDRESS << 1)
#define MPU9250_ADDRESS_DEFAULT_ADO_HIGH	(MPU9250_ADDRESS_ADO_HIGH << 1)
#define READ_FLAG   0x80

#define AK8963_ADDRESS_DEFAULT (AK8963_ADDRESS << 1)
/*********************
*			Peripheral
*********************/
...
/**********************************************************
***	Read data send from a register of the device ***
*	Register_address : address of register of device want to read data
*	pBuffer : storage the data
*	Device_address : own address of the device 
*	Byte_Length : Length of Buffer
**********************************************************/
void Write_Bytes(u8 Register_address, u8 Device_address, u8 Value);
/*********************************************************
*** Write value to a register of the device ***
*********************************************************/
int Check_Connection(u8 Register_address, u8 Device_address, u8 Return_true_val);
/*********************************************************
*** Check connection of MPU9250 - return 1 then OK / 2 then failed***
*********************************************************/
void Set_Clock(int ado_bit);
/*********************************************************
*** Set Clock for MPU9250 ***
*********************************************************/
